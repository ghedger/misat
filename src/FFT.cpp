...
// GPH Long stream of dependencies required to get wx libraries running.
// The purpose of this exercise is purely mathematical and I don't
// want to get sucked down the dependency rabbit hole at this time...
#if 0
